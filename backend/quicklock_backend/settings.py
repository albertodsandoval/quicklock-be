"""
Django settings for quicklock_backend project.
...
SECRET_KEY = 'django-insecure-cm*27qqkj4l9+9)(@rp4j#8*!8-j7wvodxt%vk*9jy^zsj6mu$'
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "quicklock_db"),
